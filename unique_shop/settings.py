"""
Django settings for unique_shop project.
...
WSGI_APPLICATION = 'unique_shop.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'niechwiej.mateusz@gmail.com'
else:
